...
public class BossobstacleImage {
    private final ComponentImage OBSTACLE_IMAGE;
    private int spaceBehind;

    public Coordinates coordinates;

    public BossobstacleImage(BufferedImage OBSTACLE_IMAGE) {
    ...
    public BossobstacleImage(BufferedImage OBSTACLE_IMAGE, int spaceBehind) {
        this.OBSTACLE_IMAGE = new ComponentImage(OBSTACLE_IMAGE, 0, GROUND_Y - OBSTACLE_IMAGE.getHeight(), Color.red);
    ...
    public BossobstacleImage(BufferedImage OBSTACLE_IMAGE, int x, int spaceBehind) {
